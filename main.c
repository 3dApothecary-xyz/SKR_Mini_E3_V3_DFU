...
HAL_StatusTypeDef clearResult;
  ...
  /* USER CODE BEGIN 3 */
  if (HAL_OK == (clearResult = ClearnBootSel())) {  // nBOOT_SEL is Reset Upon Execution Entry
    while (1) {
      HAL_GPIO_TogglePin(GPIOD, GPIO_PIN_8);
      HAL_Delay(200);  //  Short Flash
      HAL_GPIO_TogglePin(GPIOD, GPIO_PIN_8);
      HAL_Delay(200);  //  Short Flash
      ...
      HAL_GPIO_TogglePin(GPIOD, GPIO_PIN_8);
      HAL_Delay(1000);  //  Long Flash
      HAL_GPIO_TogglePin(GPIOD, GPIO_PIN_8);
      HAL_Delay(1000);  //  Long Flash
    }
  }
  else if (HAL_ERROR == clearResult) {  // nBOOT_SEL High and Cannot be Changed
    HAL_GPIO_WritePin(GPIOD, GPIO_PIN_8, GPIO_PIN_SET);
  }
  else {  //  (HAL_OK | HAL_ERROR): nBOOT_SEL Reset Successfully
    while (1) {
      HAL_GPIO_TogglePin(GPIOD, GPIO_PIN_8);
      HAL_Delay(1000);  //  Long Flash
      HAL_GPIO_TogglePin(GPIOD, GPIO_PIN_8);
